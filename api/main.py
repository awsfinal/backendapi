...
# from services.kakao_service_mock import kakao_service_mock as kakao_service  # Mock 서비스 (테스트용)
...
async def capture_photo(
    ...
    try:
        ...
        # 1. 카카오 API로 장소 정보 조회
        place_info = await kakao_service.get_place_by_coordinates(
            gps_coords.latitude, 
...
async def test_gps_location(
    ...
    try:
        ...
        # 카카오 API로 장소 정보 조회
        place_info = await kakao_service.get_place_by_coordinates(latitude, longitude)
...
async def search_place(
    ...
    try:
        ...
        place_info = await kakao_service.search_place_by_keyword(keyword, latitude, longitude)
